...
class CookieMiddleWare:
    ...
    def _get_random_cookies(self):
        try:
            res = requests.get(self.cookies_pool_url)
...
class UaMiddleWare:
    ...
    def process_request(self, request, spider):
        request.headers['USER_AGENT'] = random.choice(self.ua_list)
...
class ProxyMiddleWare:
    ...
    def _get_random_proxy(self):
        return requests.get(self.proxy_pool_url).text
